window.BUILDINGS = [
    ...
    },
    {
        ...
        zone: "univerzitna-zona",
        name: "Both",
        modelPath: "assets/models/Both.glb",
        description: "Kombinovaný model univerzitnej zóny.",
        wikiInfoSK: "Areál univerzitnej mestskej zástavby v Košiciach združuje budovy UPJŠ a súvisiacu infraštruktúru v širšej univerzitnej zóne mesta. Predstavuje významné centrum vzdelávania na východnom Slovensku.",
        wikiInfoEN: "The university built-up area in Košice groups UPJŠ buildings and related infrastructure in the wider university zone. It is a major centre of higher education in eastern Slovakia.",
        location: "Univerzitná zóna, Košice",
        type: "Univerzitný komplex",
        style: "Moderná architektúra",
        period: "Súčasný digitálny model",
        architect: "Neuvedené",
        sourceUrl: "",
    ...
    },
    {
        ...
        zone: "mestska-zona",
        name: "MODEL_PALACKEHO",
        modelPath: "assets/models/MODEL_PALACKEHO.glb",
        description: "Model objektu Palackého.",
        wikiInfoSK: "Okolie ulice Palackého v Košiciach tvorí dôležitú mestskú križovatku medzi historickým centrom a železničnou stanicou. V tejto zóne sa mieša historická a novšia zástavba verejných budov.",
        wikiInfoEN: "The Palackého Street area in Košice is an important urban link between the historic centre and the railway station. The zone mixes historic and more recent public architecture.",
        location: "Palackého, Košice",
        type: "Mestská budova",
        style: "Moderná mestská architektúra",
        period: "Súčasný digitálny model",
        architect: "Neuvedené",
        sourceUrl: "",
        sourceNote: "3D model vytvorený pre projekt Virtuálne Košice (vlastná tvorba). / 3D model created for the Virtual Košice project (original work).",
